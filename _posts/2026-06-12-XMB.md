...
Small project developed in one week. The goal was to recreate the PS3's XMB on PC, allowing users to add and launch games.
...
[Demo video](https://youtu.be/44lBt11tQ5Q)
...
Piccolo progetto realizzato in una settimana. Lo scopo era quello di ricreare la XMB della PS3 su PC, consentendo di aggiungere giochi e avviarli.
...
```
 ...
 [Video dimostrativo](https://youtu.be/44lBt11tQ5Q)
