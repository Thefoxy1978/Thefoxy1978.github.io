...
For now, we keep moving forward. I don’t have an exact date for the next beta.
In the meantime, you can try the beta and give us feedback.
...
Per il momento si procede, non ho una data precisa per la prossima beta.
Nel frattempo potete provare la beta e darci un feedback.
